...
function showadmin() {
    $.ajax({
        url: "staffview/adminmanagement.php",
        method: "POST",
        success: function(data) {
...
function refreshAdminList() {
    $.ajax({
        url: 'staffview/adminmanagement.php',  // PHP script that returns updated rows
        method: 'GET',
        success: function(data) {
...
function refreshProductList() {
    updateContent('staffview/viewAllProducts.php', {}, '.allContent-section');
}

// Function to show table views dynamically
function showTableViews() {
    $.ajax({
        url: "staffview/viewTable.php",  // Adjust this path to your actual view table script
        method: "POST",
...
function tableEditForm(id) {
    $.ajax({
        url: "staffview/editables-forms.php",  // URL to load the edit form for tables
        method: "POST",
...
function refreshUpdateTableList() {
    $.ajax({
        url: 'staffview/viewTable.php',  // URL to load the table list
        method: 'GET',
        success: function(data) {
...
function showCategory() {
    $.ajax({
        url: "staffview/viewAllCategory.php",
        method: "post",
        data: { record: 1 },
        success: function(data) {
            $('.allContent-section').html(data);
...
function categoryEditForm(id) {
    $.ajax({
        url: "staffview/editcategory-form.php",  // URL to load the edit form for categories
        method: "POST",
