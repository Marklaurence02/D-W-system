...
<header class="custom-header">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-flex" aria-label="Main Navigation">
    ...
    <a href="index.php#contact-section"><i class="fa fa-phone"></i> Contact Us</a>
        ...
        <button class="openbtn d-lg-none" onclick="toggleSidebar()" aria-label="Toggle Sidebar"><i class="fa fa-bars"></i></button>
    </div>
</header>
...
<script>
    function toggleSidebar() {
        ...
        sidebar.style.width = isOpen ? "0" : "250px"; // Adjust width for better visibility
...
<section class="hero-section py-5" id="hero-section">
    <div class="container">
        <div class="col-md-8 mx-auto text-center">
            <h1 class="display-4">
                WELCOME TO
                <img src="Images/dinewatchlogo.png" alt="Dine & Watch Logo" class="inline-logo img-fluid">
            </h1>
