    ...
    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <input type="file" accept="image/*" name="back_view" id="back_view" class="form-control-file mt-2" onchange="previewImage(this, 'back_view_preview')">
            </div>
            ...
            <div class="col-md-6 text-center">
                ...
                <input type="file" accept="image/*" name="left_view" id="left_view" class="form-control-file mt-2" onchange="previewImage(this, 'left_view_preview')">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <input type="file" accept="image/*" name="right_view" id="right_view" class="form-control-file mt-2" onchange="previewImage(this, 'right_view_preview')">
            </div>
            ...
            <div class="col-md-6 text-center">
                ...
                <input type="file" accept="image/*" name="front_view" id="front_view" class="form-control-file mt-2" onchange="previewImage(this, 'front_view_preview')">
            </div>
        </div>
    </div>
