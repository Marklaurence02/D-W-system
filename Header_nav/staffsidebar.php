...
<div class="text-center mb-4" id="welcomeMessage">
    ...
    <ul class="nav nav-pills flex-column">
        <li class="nav-item"><a href="Staff-panel.php" class="nav-link text-white"><i class="fa fa-cart-arrow-down sideicon"></i><span class="ml-2">Dashboard</span></a></li>
        ...
        <li class="nav-item"><a href="Smessage.php" class="nav-link text-white"><i class="fa fa-envelope sideicon"></i><span class="ml-2">Messages</span></a></li>
    </ul>
</div>
